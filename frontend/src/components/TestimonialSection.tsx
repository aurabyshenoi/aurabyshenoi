  ...
  const dummyTestimonials: Testimonial[] = [
    {
      ...
      testimonialText: 'The painting I purchased exceeded all my expectations. The colors are so vibrant and the detail is incredible. It has become the centerpiece of my living room.',
      rating: 5,
      isActive: true,
      displayOrder: 1,
    ...
    },
    {
      ...
      testimonialText: 'Working with this artist was a wonderful experience. The painting arrived perfectly packaged and the quality is museum-worthy. Highly recommended!',
      rating: 5,
      isActive: true,
      displayOrder: 2,
    ...
    },
    {
      ...
      testimonialText: 'From the moment I saw this painting online, I knew it had to be mine. The colors perfectly complement my decor and it never fails to spark conversation.',
      rating: 5,
      isActive: true,
      displayOrder: 5,
